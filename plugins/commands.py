...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**ᴘʟᴇᴀꜱᴇ ᴊᴏɪɴ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ! ഞങ്ങളുടെ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ ജോയിൻ ചെയ്തതിന് ശേഷം ᴛʀʏ ᴀɢᴀɪɴ എന്ന ബട്ടൺ ക്ലിക്ക് ചെയ്താൽ നിങ്ങൾ ചോദിച്ച മൂവി കിട്ടുന്നതാണ്...🤓!

𝐂𝐨𝐩𝐲𝐫𝐢𝐠𝐡𝐭 കിട്ടി 𝐂𝐡𝐚𝐧𝐧𝐞𝐥𝐬 ഏതു നിമിഷവും പോകുന്നതുകൊണ്ടാണ് എല്ലാവരോടും 𝐁𝐚𝐜𝐤𝐮𝐩 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 ജോയിൻ ചെയാൻ പറയുന്നത്... അതുകൊണ്ട് താങ്കൾ ഈ ചാനലിൽ ലെഫ്റ്റ് അടിക്കാതെ തുടരും എന്ന് വിചാരിക്കുന്നു...😊♻️**",
