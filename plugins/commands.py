...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**ᴘʟᴇᴀꜱᴇ ᴊᴏɪɴ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ! ഞങ്ങളുടെ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ ജോയിൻ ചെയ്തതിന് ശേഷം ᴛʀʏ ᴀɢᴀɪɴ എന്ന ബട്ടൺ ക്ലിക്ക് ചെയ്താൽ നിങ്ങൾ ചോദിച്ച മൂവി കിട്ടുന്നതാണ്...🤓/n🔰 ഇതിൽ ജോയിൻ ചെയ്യാൻ പറയുന്നത് മൂവീസ് ചാനൽസ് ആയതിനാൽ ഏത് നിമിഷവും copyright കിട്ടി ചാനൽസ് ban ആവാൻ സാധ്യത ഉണ്ട്...അതുകൊണ്ട് ഈ ചാനലിൽ നിന്നും താങ്കൾ ലെഫ്റ്റ് ആവില്ല എന്ന് കരുതുന്നു...❤️!**",
