...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("**🔊 നിർബദ്ധമായും ഇത് വായിക്കുക... 🔊**\n\nI Couldn't Find Anything Related To That   Did You Mean Any One Of These? 🧐\n\nനിങ്ങൾ ചോദിച്ച സിനിമ എനിക്ക് കണ്ടെത്താൻ കഴിഞ്ഞില്ല...😔താഴെ കൊടുത്തിരിക്കുന്നതിൽ ഏതെങ്കിലും ആണോ എന്ന് നോക്കൂ...🤓 ആണെകിൽ അതിൽ CLICK ചെയൂ...🔓\n\nഇനി അതിൽ ഇല്ല എങ്കിൽ...🤕\n\nBro, Check Movie Name In #Google And Try ! Then No Results Add Movie Year And Try , Again No Results ? It's Not Available In Our Database Or Movie Not Released...🤓\n\nബ്രോ, മൂവിയുടെ പേര് മാത്രം www.google.com നോക്കിയിട്ട് ഒന്ന് കൂടെ അടിച്ചു നോക്ക്..!! 😵‍💫എന്നിട്ടും കിട്ടിയില്ലെങ്കിൽ പേരിന്റെ കൂടെ മൂവി ഇറങ്ങിയ വർഷം കൂടി അടിച്ചു നോക്ക് 😁\n\nഎനിയും കിട്ടിയില്ലെങ്കിൽ ആ മൂവി ഞങ്ങളുടെ ഡാറ്റാബേസിൽ ഇല്ല, 🤕 അല്ലെങ്കിൽ ആ മൂവി ഇറങ്ങിയിട്ടില്ല എന്ന് മനസ്സിലാക്കുക! 🤗\n\n🔴 "THIS MOVIE NOT FOUND IN DATABASE" എന്നാണ് കാണിക്കുന്നത് എങ്കിൽ @admins എന്ന് ടൈപ്പ് ആക്കി അയക്കൂ...🔊 OTT റിലീസ് ആയ സിനിമയാണെകിൽ ഞങ്ങൾ ഉടനെ അപ്‌ലോഡ് ചെയുന്നതാണ്...✅\n\nNOTE :- ഇവിടെ വെബ് സീരിസ് ചോദിച്ചാൽ കിട്ടില്ല ഇത് സിനിമ ഗ്രൂപ്പ്‌ ആണ് വെബ് സീരിസ് ആണെകിൽ @AdhologamSeries ഇവിടെ ചോദിക്കൂ...😌",
                    reply_markup=InlineKeyboardMarkup(btn))
