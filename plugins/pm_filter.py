...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("𝐈 𝐂𝐨𝐮𝐥𝐝𝐧'𝐭 𝐅𝐢𝐧𝐝 𝐀𝐧𝐲𝐭𝐡𝐢𝐧𝐠 𝐑𝐞𝐥𝐚𝐭𝐞𝐝 𝐓𝐨 𝐓𝐡𝐚𝐭\n𝐃𝐢𝐝 𝐘𝐨𝐮 𝐌𝐞𝐚𝐧 𝐀𝐧𝐲 𝐎𝐧𝐞 𝐎𝐟 𝐓𝐡𝐞𝐬𝐞?നിങ്ങൾ ചോദിച്ച സിനിമ എനിക്ക് കണ്ടെത്താൻ കഴിഞ്ഞില്ല...😔താഴെ ഉള്ളതിൽ ഏതെങ്കിലും ആണോ എന്ന് നോക്കൂ...🤓 അതും അല്ലങ്കിൽ ഗൂഗിൾ സ്പെല്ലിങ് ശരിയാണോ എന്ന് നോക്കൂ...👍",
                    reply_markup=InlineKeyboardMarkup(btn))
